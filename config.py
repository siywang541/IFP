...
# Filter type, support 'IFP', 'sr', 'deblur', 'denoise'
_C.DATA.FILTER_TYPE = 'IFP'
# [IFP] Sampling ratio for low-pass filters
_C.DATA.SAMPLE_RATIO = 0.5
# [IFP] First frequency mask radius
# should be smaller than half of the image size
_C.DATA.MASK_RADIUS1 = 16
# [IFP] Second frequency mask radius
...
# Restormer
_C.MODEL.RESTORMER = CN()
_C.MODEL.RESTORMER.INP_CHANNELS = 3
_C.MODEL.RESTORMER.OUT_CHANNELS = 64
_C.MODEL.RESTORMER.DIM = 48
_C.MODEL.RESTORMER.NUM_BLOCKS = [4,6,6,8]
_C.MODEL.RESTORMER.NUM_REFINEMENT_BLOCKS = 4
_C.MODEL.RESTORMER.HEADS = [1,2,4,8]
_C.MODEL.RESTORMER.FFN_EXPANSION_FACTOR = 2.66
_C.MODEL.RESTORMER.BIAS = False
_C.MODEL.RESTORMER.LAYERNORM_TYPE = 'WithBias'
_C.MODEL.RESTORMER.DUAL_PIXEL_TASK = False
_C.MODEL.RESTORMER.GLOBAL_RESIDUAL = False
_C.MODEL.RESTORMER.PATCH_SIZE = 1

# Uformer
_C.MODEL.UFORMER = CN()
_C.MODEL.UFORMER.IMAGE_SIZE = 256
_C.MODEL.UFORMER.PATCH_SIZE = 1
_C.MODEL.UFORMER.INP_CHANNELS = 3

# decoder
_C.MODEL.DECODER = CN()
_C.MODEL.DECODER.IN_NC = 180
_C.MODEL.DECODER.OUT_NC = 3
_C.MODEL.DECODER.UPSCALE = 1
_C.MODEL.DECODER.MODUL_CHANNELS = 512
_C.MODEL.DECODER.REQUIRE_MODULATION = True
_C.MODEL.DECODER.MODULATION_MODE = 'GFM'
...
# [IFP] Reconstruction target type, support 'normal', 'masked'
_C.MODEL.RECOVER_TARGET_TYPE = 'normal'
# [IFP] Frequency loss parameters
